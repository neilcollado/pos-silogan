...
<div class="form-group row">
    ...
    <div class="col-md-2">
        <input id="unitprice" type="number" min="0" max="10000000" step="1" value="{{ old('unitprice') }}@isset($product){{ $product->UnitPrice }}@endisset" class="form-control @error('unitprice') is-invalid @enderror" 
